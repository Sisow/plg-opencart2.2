...
<div id="content">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ppexpress" class="form-horizontal">
		<div class="form-group required">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcbc_merchantid" value="<?php echo $sisowcbc_merchantid; ?>" id="entry_merchantid" class="form-control" maxlength="32" size = "32"/>
		...
		<div class="form-group required">
			...
			<div class="col-sm-4">
				<input type="text" name="sisowcbc_merchantkey" value="<?php echo $sisowcbc_merchantkey; ?>" id="entry_merchantkey" class="form-control" maxlength="64" size = "64"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcbc_shopid" value="<?php echo $sisowcbc_shopid; ?>" id="entry_shopid" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<select name="sisowcbc_status_success" id="entry_success" class="form-control">
				<?php foreach ($order_statuses as $order_status) { ?>
				<?php if ($order_status['order_status_id'] == $sisowcbc_status_success) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowcbc_testmode" id="entry_testmode" class="form-control">
					<?php if ($sisowcbc_testmode=="true") { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcbc_total" value="<?php echo $sisowcbc_total; ?>" id="entry_total" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcbc_totalmax" value="<?php echo $sisowcbc_totalmax; ?>" id="entry_totalmax" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowcbc_geo_zone_id" id="entry_geo_zone" class="form-control">
					  <option value="0"><?php echo $text_all_zones; ?></option>
					  <?php foreach ($geo_zones as $geo_zone) { ?>
					  <?php if ($geo_zone['geo_zone_id'] == $sisowcbc_geo_zone_id) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowcbc_status" id="entry_status" class="form-control">
						<?php if ($sisowcbc_status) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcbc_sort_order" value="<?php echo $sisowcbc_sort_order; ?>" id="entry_sort_order" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
