...
<div id="content">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ppexpress" class="form-horizontal">
		<div class="form-group required">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcapayable_merchantid" value="<?php echo $sisowcapayable_merchantid; ?>" id="entry_merchantid" class="form-control" maxlength="32" size = "32"/>
		...
		<div class="form-group required">
			...
			<div class="col-sm-4">
				<input type="text" name="sisowcapayable_merchantkey" value="<?php echo $sisowcapayable_merchantkey; ?>" id="entry_merchantkey" class="form-control" maxlength="64" size = "64"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcapayable_shopid" value="<?php echo $sisowcapayable_shopid; ?>" id="entry_shopid" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<select name="sisowcapayable_status_success" id="entry_success" class="form-control">
				<?php foreach ($order_statuses as $order_status) { ?>
				<?php if ($order_status['order_status_id'] == $sisowcapayable_status_success) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowcapayable_testmode" id="entry_testmode" class="form-control">
					<?php if ($sisowcapayable_testmode=="true") { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcapayable_total" value="<?php echo $sisowcapayable_total; ?>" id="entry_total" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcapayable_totalmax" value="<?php echo $sisowcapayable_totalmax; ?>" id="entry_totalmax" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowcapayable_geo_zone_id" id="entry_geo_zone" class="form-control">
					  <option value="0"><?php echo $text_all_zones; ?></option>
					  <?php foreach ($geo_zones as $geo_zone) { ?>
					  <?php if ($geo_zone['geo_zone_id'] == $sisowcapayable_geo_zone_id) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowcapayable_status" id="entry_status" class="form-control">
						<?php if ($sisowcapayable_status) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowcapayable_sort_order" value="<?php echo $sisowcapayable_sort_order; ?>" id="entry_sort_order" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
