...
<div id="content">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ppexpress" class="form-horizontal">
		<div class="form-group required">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvvv_merchantid" value="<?php echo $sisowvvv_merchantid; ?>" id="entry_merchantid" class="form-control" maxlength="32" size = "32"/>
		...
		<div class="form-group required">
			...
			<div class="col-sm-4">
				<input type="text" name="sisowvvv_merchantkey" value="<?php echo $sisowvvv_merchantkey; ?>" id="entry_merchantkey" class="form-control" maxlength="64" size = "64"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvvv_shopid" value="<?php echo $sisowvvv_shopid; ?>" id="entry_shopid" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<select name="sisowvvv_status_success" id="entry_success" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowvvv_testmode" id="entry_testmode" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvvv_total" value="<?php echo $sisowvvv_total; ?>" id="entry_total" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvvv_totalmax" value="<?php echo $sisowvvv_totalmax; ?>" id="entry_totalmax" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowvvv_geo_zone_id" id="entry_geo_zone" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowvvv_status" id="entry_status" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvvv_sort_order" value="<?php echo $sisowvvv_sort_order; ?>" id="entry_sort_order" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
